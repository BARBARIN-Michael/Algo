...
/*   Updated: 2015/02/24 14:57:00 by mbarbari         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char	*add_lenght(char *str, t_opt *opt, int mod)
{
	...
	if (opt->lenght > ft_strlen(str) && opt->opt_neg)
		s1 = ft_strset(str, pos, opt->lenght - ft_strlen(str), c);
	else if (opt->lenght > ft_strlen(str) && opt->opt_0)
		s1 = ft_strset(str, pos + offset, opt->lenght - ft_strlen(str), c);
	else if (opt->lenght > ft_strlen(str))
		s1 = ft_strset(str, pos, opt->lenght - ft_strlen(str), c);
	return (s1);
}
